...
; ***************
           ...
           .BYTE $93,$0d,$40
           .BYTE " COMMODORE BASIC V7.0"
           .BYTE " 122365 BYTES FREE"
           .BYTE $0d,$40
           .BYTE "   (C)1986 COMMODORE"
           .BYTE " ELECTRONICS, LTD."
           .BYTE $0d,$40
           .BYTE "         (C)1977"
           .BYTE " MICROSOFT CORP."
           .BYTE $0d,$40
...
; **********************
          ...
          .BYTE "TOO MANY FILES"^        ; $01
          .BYTE "FILE OPEN"^             ; $02
          .BYTE "FILE NOT OPEN"^         ; $03
          .BYTE "FILE NOT FOUND"^        ; $04
          .BYTE "DEVICE NOT PRESENT"^    ; $05
          .BYTE "NOT INPUT FILE"^        ; $06
          .BYTE "NOT OUTPUT FILE"^       ; $07
          .BYTE "MISSING FILE NAME"^     ; $08
          .BYTE "ILLEGAL DEVICE NUMBER"^ ; $09
          .BYTE "NEXT WITHOUT FOR"^      ; $0a
          .BYTE "SYNTAX"^                ; $0b
          .BYTE "RETURN WITHOUT GOSUB"^  ; $0c
          .BYTE "OUT OF DATA"^           ; $0d
          .BYTE "ILLEGAL QUANTITY"^      ; $0e
          .BYTE "OVERFLOW"^              ; $0f
          .BYTE "OUT OF MEMORY"^         ; $10
          .BYTE "UNDEF'D STATEMENT"^     ; $11
          .BYTE "BAD SUBSCRIPT"^         ; $12
          .BYTE "REDIM'D ARRAY"^         ; $13
          .BYTE "DIVISION BY ZERO"^      ; $14
          .BYTE "ILLEGAL DIRECT"^        ; $15
          .BYTE "TYPE MISMATCH"^         ; $16
          .BYTE "STRING TOO LONG"^       ; $17
          .BYTE "FILE DATA"^             ; $18
          .BYTE "FORMULA TOO COMPLEX"^   ; $19
          .BYTE "CAN'T CONTINUE"^        ; $1a
          .BYTE "UNDEF'D FUNCTION"^      ; $1b
          .BYTE "VERIFY"^                ; $1c
          .BYTE "LOAD"^                  ; $1d
          .BYTE "BREAK"
          .BYTE $00,$a0
...
; ***********************
          ...
          .BYTE "CAN'T RESUME"^          ; $1f
          .BYTE "LOOP NOT FOUND"^        ; $20
          .BYTE "LOOP WITHOUT DO"^       ; $21
          .BYTE "DIRECT MODE ONLY"^      ; $22
          .BYTE "NO GRAPHICS AREA"^      ; $23
          .BYTE "BAD DISK"^              ; $24
          .BYTE "BEND NOT FOUND"^        ; $25
          .BYTE "LINE NUMBER TOO LARGE"^ ; $26
          .BYTE "UNRESOLVED REFERENCE"^  ; $27
          .BYTE "UNIMPLEMENTED COMMAND"^ ; $28
          .BYTE "FILE READ"^             ; $29
...
BAER_40   LDA (INDEXB),Y
          ...
          JSR Init_BASIC_Stack
          JSR B_PRIMM
          .BYTE " ERROR",0    ; append "ERROR" to message
...
; ***************
          ...
          .BYTE " ,.$"        ; PU_FILL, PU_COMMA, PU_DOT, PU_MONEY
...
;           Credits
          ...
          .BYTE "FRED B\r"    ; Fred Bowen
          .BYTE "TERRY R\r"   ; Terry Ryan
          .BYTE "MIKE I\r"    ; Mike Isgur
...
GSHA_14   CPX #1
          ...
          ORA YRADIUS
          BIT
GSHA_16   EOR #%1111 1111 ; $ff
GSHA_18   AND #%0000 0011 ; $03
          BIT GRAPHM
          BMI GSHA_20
          AND #%0000 0001 ; $01
GSHA_20   STA COLSEL
...
SC_320    .REAL $991fff6000 ; 20971200 = 320 * 65535
SC_200    .REAL $9847ff3800 ; 13107000 = 200 * 65535
...
COPY_FROM .BYTE "COPY FROM?",0
SPRITE_NO .BYTE "SPRITE NUMBER?  ",0
SPRITECMD .BYTE "1234",$03,$8d,"XYM",$9d
...
; ******************
          ...
          JSR Map_IO
          LDA VIC_Ctrl_1
          AND #%0110 1111     ; clear device enable bit 4
          STA VIC_Ctrl_1
          LDA #1
...
; ******************
          ...
          LDA VIC_Ctrl_1
          AND #%0111 1111     ; clear RST8
          ORA #%0001 0000     ; set device enable bit 4
          STA VIC_Ctrl_1
          RTS
...
Real_PI   .REAL $82490fdaa1;    3.14159265254
...
RCLR_70   LDA #$1a
          STA VDC_Register
          LDA VDC_Data
RCLR_80   AND #%0000 1111 ; $0f
          TAX
          LDA unadju_8563,X
RCLR_90   AND #%0000 1111 ; $0f
          TAY
          INY
          JMP Y_To_Real
...
rmulc     .REAL $9835447a00 ; 11879546.00000000000
raddc     .REAL $6828b14600 ;        0.00000003928
n32768    .REAL $9080000000 ;   -32768.00000000000
...
Real_1    .REAL $8100000000;    1.00000000000
...
Sqrt2half .REAL $803504f334;    0.70710678119
Sqrt2     .REAL $813504f334;    1.41421356238
Minus0_5  .REAL $8080000000;   -0.50000000000
Ln2       .REAL $80317217f8;    0.69314718060
...
Real_10   .REAL $8420000000;   10.00000000000
...
R9E9      .REAL $9b3ebc1ffd; 99999999.90625000000
R9E10     .REAL $9e6e6b27fd; 999999999.25000000000
R1E10     .REAL $9e6e6b2800; 1000000000.00000000000
...
LPS_10    JSR B_READST
          AND #%1011 1111     ; test all but EOI (but 6)
          BEQ LPS_30
LPS_Err   LDX #$1d            ; LOAD
...
Real_0_25 .REAL $7f00000000;    0.25000000000
...
; *******************
          ...
          LDA #%0010 0010     ; inhibit second drive and filename
          JSR DOS_Parser_A
...
;               @WDD ULFF
          LDA #%1110 0010     ; accept LA,Drive,Unit,File
          JSR DOS_Parser_A
          JSR Require_LA_Filename
          JSR Find_Free_SA
...
; ********************
          ...
          LDA #%1111 0011     ; allow only LA and Unit
          JSR DOS_Parser_A
          JSR Free_DOS_Status_String
          LDA DOSFLA
          AND #%0000 0100     ; test LA bit
...
; ********************
          ...
          JSR ARE_YOU_SURE
          BNE HEAD_Ret
          LDY #Pat_HEADER - Pat_DCLEAR - 1
          LDA #?Pat_HEADER - 2 ; no ID
          LDX DOS_ID
          BEQ HEAD_10
          LDA #?Pat_HEADER
...
; ******************
          ...
          JSR DOS_Parser
          AND #%0011 0000   ; source & target drive
          CMP #%0011 0000
          BNE COPY_10
          LDA DOSFLA        ; source and target drive set
          AND #%1100 0111   ; @ W LA FN1 FN2
          BEQ COPY_20       ; -> copy *
COPY_10   LDA DOSFLA
          JSR Deny_AT_W_LA
          LDA DOSFLA        ; obsolete
COPY_20   LDY #Pat_COPY - Pat_DCLEAR - 1
          LDA #?Pat_COPY    ; command length
          BNE Put_DOS_Command
...
; ************************
           ...
           LDA DOSFLA
           ORA #%1000 0000    ; set replace flag
           STA DOSFLA
           DEX
...
; .......0 raster interrupt
          ...
          AND #%0000 1110     ; light-pen, sprite collision
...
; *******************
          ...
          SEC
          LDA VIC_IRQ_REG
          AND #%0000 0001     ; raster interrupt ?
          BEQ RAST_10         ; -> no
...
RAST_10   BEQ RAST_80         ;
          ...
          AND #%0100 0000     ; test split screen
...
RAST_20   SEC
          ...
          STA VIC_RASTER
RAST_30   LDA R8502
          AND #%1111 1101     ; $E000-$EFFF : RAM
          ORA #%0000 0100     ; $D000-$Dfff : I/O
          PHA                 ; save mask
          LDA VSH_BITMAP      ; save bitmap pointer
          PHA
          LDA VIC_Ctrl_1
          AND #%0111 1111     ; reset bit8 of raster register
          ORA #%0010 0000     ; enable bitmap mode
          TAY                 ; save mask in Y
          LDA VIC_Ctrl_2
          BIT GRAPHM
          BMI RAST_40         ; -> multi color mode
          AND #%1110 1111     ; Disable multi color mode
          BIT                 ; skip next statement
RAST_40   ORA #%0001 0000     ; Enable multi color mode
          TAX                 ; save mask in X
          BNE RAST_70         ; branch always
RAST_50   LDA #$ff
          STA VIC_RASTER
          LDA R8502
          ORA #%0000 0010     ; $E000-$FFFF : Kernal  ROM
          AND #%1111 1011     ; $D000-$DFFF : Chargen ROM
          ORA CHAREN
          PHA                 ; save mask
          LDA VSH_TEXT
          PHA
          LDA VIC_Ctrl_1
          AND #%0101 1111     ; switch off bitmap mode
          TAY                 ; save mask in Y
          LDA VIC_Ctrl_2
          AND #%1110 1111     ; switch off multi color mode
          TAX                 ; save mask in X
          BCS RAST_70
...
; *********************
          ...
          LDA R8502
          AND #%0100 0000     ; extract bit 6 : ASCII/DIN
          EOR #%0100 0000     ; toggle  bit 6
          LSR A
...
PrSh_30   ORA #%0100 0000     ; convert to display code
          JMP PTS_20
...
; cursor in 80 column screen
          ...
          AND #%1111 0000     ; invert char
          STA E_Beg+1
          JSR VDC_Set_Attr_Address
          LDA E_Attribute
          AND #%0000 1111     ; invert color
          ORA E_Beg+1
          JSR VDC_Write_Data
ECON_10   LDX #10
          LDA CURMOD
...
;                f1  f2  f3  f4  f5  f6  f7  f8 RUN HELP
          ...
          .BYTE "LIST\r"      ; f7
          .BYTE "MONITOR\r"   ; f8
          .BYTE "D",$cc,QUOTE,"*\rRUN\r" ; DLOAD"* and RUN
          .BYTE "HELP\r"
...
; *************
          ...
          ORA #%0010 0000     ; $20 set LISTEN bit
          JSR RS232_Stop
...
ISB_50    JSR IEC_Clock_High
          ...
          NOP
          LDA CIA2_PRA
          AND #%1101 1111       ; $df DATA  OUT high
          ORA #%0001 0000       ; $10 CLOCK OUT low
          STA CIA2_PRA
          DEC CNTDN             ; next bit
          BNE ISB_40            ; loop
...
; *****************
          ...
          PHA
          LDA Fast_IEC
          AND #%0111 1111     ; $7f clear fast IEC flag
          STA Fast_IEC
          PLA
          JSR SETST
...
; **********************
          ...
          LDA CIA1_CRA
          AND #%1000 0000 ; $80 save TOD flag
          ORA #%0000 1000 ; $08 set ONE SHOT flag
          STA CIA1_CRA
          LDA MMU_MODE
          AND #%1111 0111 ; $f7 fast serial direction input
          STA MMU_MODE
          RTS
...
; ***********************
          ...
          LDA MMU_MODE
          ORA #%0000 1000     ; $08 Fast IEC direction output
          STA MMU_MODE
          LDA #$7f
...
RNS_20    TXA
          AND #%0000 0100     ; $04 bit 2 = transfer position
          STA RS_Next
          RTS
...
RNS_30    LDA #%0010 0000     ; $20 ODD parity
          BIT RS_Command
...
RSCI_10   LDA RS_Enable
          ...
          LDA CIA2_PRB
          AND #%1111 1101     ; $fd RTS request to send
          STA CIA2_PRB
...
; *******************
          ...
          STA CIA2_ICR
          TXA
          AND #%0001 0010     ; RS232 input & TIMER B
          BEQ RSNM_20
          AND #%0000 0010     ; TIMER B
...
; ********************
          ...
          LDA VIC_Ctrl_1
          ORA VSH_Ctrl_1
          AND #%0111 1111     ; disable all interrupts
          STA VIC_Ctrl_1
          BIT SPRITES
...
; ***********************
          ...
          LDA R8502
          ORA #%0010 0000     ;  cassette motor off
          STA R8502
          RTS
...
; ********************
          ...
          PHP
          PLA
          AND #%1110 1111     ; $ef set IRQ/BRK bit to IRQ
          PHA
          JMP IRQ
...
; *************************
          ...
          LDA R8502
          ORA #%0010 0000     ; $20 bit5 = 1 : motor off
          BNE TSS_20          ; always
TSS_10    LDA CAS1            ; test motor flag
          BNE TSS_Ret         ; -> motor is already on
          LDA R8502
          AND #%1101 1111     ; $df bit5 = 0 : motor on
...
; *******************
          ...
          LDA RS_Status
          AND #%0110 0000     ; $60 check DSR signal (bit 6)
...
LOAD_10   LDA Fast_IEC
          AND #%1011 1110     ; $be clear burst mode bit 6
...
TALO_30   SEC
          LDA STATUS
          AND #%0001 0000     ; $10 bit 4: verify error
          BNE LOAD_Ret
...
RBBl_10   BIT CIA1_ICR
          ...
          LDA CIA2_PRA
          EOR #%0001 0000     ; $10 toggle CLOCK OUT
          STA CIA2_PRA
          TYA                 ; A = data byte
...
; *********************
  ...
  Msg_Play      = * - Message_Table
          .BYTE "\rPRESS PLAY ON TAPE"^
  Msg_Record    = * - Message_Table
          .BYTE "PRESS RECORD & PLAY ON TAPE"^
...
; .... ...x $d000 - $dfff
          ...
          .BYTE %0011 1111    ; $3f RAM 0
          .BYTE %0111 1111    ; $7f RAM 1
          .BYTE %1011 1111    ; $bf RAM 2
          .BYTE %1111 1111    ; $ff RAM 3

          .BYTE %0001 0110    ; $16 internal ROM, RAM 0, I/O
          .BYTE %0101 0110    ; $56 internal ROM, RAM 1, I/O
          .BYTE %1001 0110    ; $96 internal ROM, RAM 2, I/O
          .BYTE %1101 0110    ; $d6 internal ROM, RAM 3, I/O

          .BYTE %0010 1010    ; $2a external ROM, RAM 0, I/O
          .BYTE %0110 1010    ; $2a external ROM, RAM 1, I/O
          .BYTE %1010 1010    ; $2a external ROM, RAM 2, I/O
          .BYTE %1110 1010    ; $2a external ROM, RAM 3, I/O

          .BYTE %0000 0110    ; $06 kernal, int.  ROM, RAM 0, I/O
          .BYTE %0000 1010    ; $0a kernal, ext.  ROM, RAM 0, I/O
          .BYTE %0000 0001    ; $01 kernal, BASIC ROM, RAM 0, CHAR
          .BYTE %0000 0000    ; $00 kernal, BASIC ROM, RAM 0, I/O
...
BootComm  .BYTE "00 10 0 31:1U" ; U1:13 0 01 00 (1st. sector)
InitDrive .BYTE "I"
Hash      .BYTE "#"
...
; *********************
          ...
          .BYTE "AEU"  ,$af   ; vocals with grave
          .BYTE "AEIOU"       ; vocals with circumflex
...
; ********************
          ...
          LDA R8502
          AND #%0100 0000     ; $40 extract bit 6
          EOR #%0100 0000     ; $40 flip    bit 6
          LSR A
